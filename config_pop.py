...
root_paths = ["/home/john.vargas/data/pomelo_input_data/",
    ...
    "/scratch3/ldominiak/luca_pomelo_input_data/"]
...
input_paths = {
    ...
    #### To here
    "tza": {
        "buildings_google": f"{root_path}TZA_covariates/TZA_gbp_BCB_v1_count.tif", #
        "buildings_maxar": f"{root_path}TZA_covariates/TZA_mbp_BCB_v3_count.tif",
        "buildings_google_mean_area": f"{root_path}TZA_covariates/TZA_gbp_BCB_v1_mean_area.tif",
        "buildings_maxar_mean_area": f"{root_path}TZA_covariates/TZA_mbp_BCB_v3_mean_area.tif",
        "tza_tt50k_100m_2000": f"{root_path}TZA_covariates/tza_tt50k_100m_2000.tif", 
        "tza_dst_bsgme_100m_2015": f"{root_path}TZA_covariates/tza_dst_bsgme_100m_2015.tif", 
        "tza_dst_ghslesaccilcgufghsll_100m_2014": f"{root_path}TZA_covariates/tza_dst_ghslesaccilcgufghsll_100m_2014.tif", 
        "tza_dst_coastline_100m_2000_2020": f"{root_path}TZA_covariates/tza_dst_coastline_100m_2000_2020.tif", 
        "tza_dmsp_100m_2011": f"{root_path}TZA_covariates/tza_dmsp_100m_2011.tif", 
        "tza_esaccilc_dst_water_100m_2000_2012": f"{root_path}TZA_covariates/tza_esaccilc_dst_water_100m_2000_2012.tif", 
        "tza_osm_dst_roadintersec_100m_2016": f"{root_path}TZA_covariates/tza_osm_dst_roadintersec_100m_2016.tif", 
        "tza_osm_dst_waterway_100m_2016": f"{root_path}TZA_covariates/tza_osm_dst_waterway_100m_2016.tif", 
        "tza_osm_dst_road_100m_2016": f"{root_path}TZA_covariates/tza_osm_dst_road_100m_2016.tif", 
        "tza_srtm_slope_100m": f"{root_path}TZA_covariates/tza_srtm_slope_100m.tif", 
        "tza_srtm_topo_100m": f"{root_path}TZA_covariates/tza_srtm_topo_100m.tif", 
        "tza_viirs_100m_2015": f"{root_path}TZA_covariates/tza_viirs_100m_2015.tif", 
        "tza_wdpa_dst_cat1_100m_2015": f"{root_path}TZA_covariates/tza_wdpa_dst_cat1_100m_2015.tif" 
    },
    "uga": {
    ...
    "zmb" : {
        "buildings_google": f"{root_path}ZMB/covariates/ZMB_own_google_bcount.tif",
        "buildings_maxar": f"{root_path}ZMB/covariates/ZMB_buildings_v2_0_count.tif",
        "buildings_google_mean_area": f"{root_path}ZMB/covariates/ZMB_own_google_barea_v3.tif",
...
norms = {
    ...
    "che": {
        ...
        "che_tt50k_100m_2000": (209.1351, 188.1936),
        "che_dst_bsgme_100m_2015": (3.2670, 4.2283),
        "che_dst_ghslesaccilcgufghsll_100m_2014": (3.3381, 4.2542),
        "che_dst_coastline_100m_2000_2020": (698.8104,  326.6751),
        "che_dmsp_100m_2011": (71.8836 ,  399.8602 ),
        "che_esaccilc_dst_water_100m_2000_2012":(18.1815, 14.8920), 
        "che_osm_dst_roadintersec_100m_2016":(19.8096, 29.5883), 
        "che_osm_dst_waterway_100m_2016": (15.2655, 15.4519), 
        "che_osm_dst_road_100m_2016": (3.7082,  5.6608), 
        "che_srtm_slope_100m": (3.2089 , 3.8157),
        "che_srtm_topo_100m": (1143.9080 , 402.7680),
        "che_viirs_100m_2015": (0.2205 , 1.0825),
        "che_wdpa_dst_cat1_100m_2015": (388.8701 , 221.6834),
