            ...
            for epoch in tnr:
                ...
                for sample in tqdm(train_loader, disable=params["silent_mode"]):
                    ...
                    if batchiter % 50 == 0:
                        ...
                        mae = my_mean_absolute_error(pred_array, gt_array)
                        mape = mean_absolute_percentage_error(gt_array, pred_array)
                        ...
                        # Reset the prediction and ground truth lists
                        pred_list.clear()
                        gt_list.clear()
                        ...
                        train_log_dict[train_dataset_name[0]+'/'+'mape'] = mape[0]
                        train_log_dict[train_dataset_name[0]+'/'+'mae'] = mae[0]
